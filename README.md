...
| [Clinical Help Desk: Pre-Installation & Planning](https://github.com/the-buike/osTicket---Ashgrove-Clinic-Configuration) | Planning Docs Included | Environment prep and requirements gathering for the clinic help desk — server sizing, dependencies, and design decisions before touching the installer. | osTicket · Ubuntu Server · MySQL/MariaDB · Markdown | ![Complete](https://img.shields.io/badge/Complete-2ea44f) |
| [Clinical Help Desk: Installation & Setup](https://github.com/the-buike/osTicket---Ashgrove-Clinic-Configuration) | Configs & Screenshots Included | osTicket install, department/help-topic structure, SLA plans, and staff/agent roles configured to mirror real clinical IT support workflows. | osTicket · PHP · MySQL/MariaDB · Apache | ![Complete](https://img.shields.io/badge/Complete-2ea44f) |
| [Clinical Help Desk: Lifecycle & Ticket Workflows](https://github.com/the-buike/osTicket---Ashgrove-Clinic-Configuration) | Ticket writeups mirrored to GitHub | Every lab issue logged as a ticket through open → triage → resolution, with root cause writeups. The habit matters as much as the builds. | osTicket · Markdown | ![In Progress](https://img.shields.io/badge/In%20Progress-blue) |
