...
| [Active Directory Domain Services Lab](https://github.com/the-buike/homelab-lab) | Screenshots Included | A Windows Server 2022 VM promoted to domain controller, with an OU structure and DNS set up for the lab domain. | Windows Server 2022 · AD DS · DNS · Proxmox | ![Complete](https://img.shields.io/badge/Complete-2ea44f) |
| Enterprise Simulation: Fictional Company Series | Coming per phase | A full hybrid environment for a fictional company. Office VLANs and switching in EVE-NG, connected to self-managed AD DS in Azure over a site-to-site VPN. | EVE-NG · Azure VNets · VPN Gateway · Windows Server 2022 | ![In Progress](https://img.shields.io/badge/In%20Progress-blue) |
| IT Ticketing & Change Documentation | Ticket writeups mirrored to GitHub | Every lab issue gets logged as a ticket with a root cause and resolution. The habit matters as much as the builds. | GLPI · Markdown | ![Queued](https://img.shields.io/badge/Queued-lightgrey) |
